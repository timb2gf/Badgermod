...
if Level == 1 then
    if Mission == 3 then
        SafeRedirect("w_mstart_skn_01.rsd")
        SafeRedirect("w_mstart_skn_02.rsd")
        SafeRedirect("w_mvic_skn_01.rsd")
        SafeRedirect("w_mvic_skn_02.rsd")
        SafeRedirect("w_mvic_skn_03.rsd")
        local Path = GetPath()
    ...
    elseif Mission == 4 then
        SafeRedirect("w_mstart_wil_01.rsd")
        SafeRedirect("w_mstart_wil_02.rsd")
        SafeRedirect("w_mstart_wil_03.rsd")
        SafeRedirect("w_mvic_wil_01.rsd")
	...
	elseif Mission == 5 then
        SafeRedirect("w_mstart_brn_01.rsd")
        SafeRedirect("w_mstart_brn_02.rsd")
        SafeRedirect("w_mstart_brn_03.rsd")
        SafeRedirect("w_mvic_brn_01.rsd")
		SafeRedirect("w_mvic_brn_02.rsd")
