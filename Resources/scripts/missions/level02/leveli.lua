...
Game.InitLevelPlayerVehicle("honor_v","level2_carstart","DEFAULT");
Game.AddCharacter("bart","bart");
--Game.SetPostLevelFMV("fmv3.rmv");
...
--Game.SetCamBestSide("sr4_bestside");
...
--Game.AddING TRAFFIC GROUP FOR LEVEL 02--
--
...
--
--Game.AddING PED GROUP FOR LEVEL 02--
--
--Z1
...
-- Game.Create a new spawn point called "catapult spawn point"
-- When within a certain radius, specified by the 4th number, it will retrieve the stateprop
-- called "beecamera" from memory and Game.Create a new instance of it named "Shelly" This prop
...
--zone3
--rail3
--Game.AddSpawnPointByLocatorScript("w_matt1","beecamera","Shelley","w_matt1","10.0","-1");
--Game.AddSpawnPointByLocatorScript("w_matt2","beecamera","Shelley","w_matt2","10.0","-1");
--Game.AddSpawnPointByLocatorScript("w_matt3","beecamera","Shelley","w_matt3","10.0","-1");
--zone4
...
--First param - min distance ( go Game.Closer and attraction mode disabled)
--2nd param - max distance ( bee will attempt to move Game.Closer )
...
--Game.AddBehaviour( "static_bee", "ATTRACTION", "2.0","20","10.0");
