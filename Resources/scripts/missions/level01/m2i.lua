...
Game.AddStage();
	...
	Game.AddObjective("dump","neither");
		...
		Game.AddCollectible("m2_bk1","is_comic");
		Game.AddCollectible("m2_bk2","is_comic");
		Game.AddCollectible("m2_bk3","is_comic");
		Game.AddCollectible("m2_bk4","is_comic");
		Game.AddCollectible("m2_bk5","is_comic");
		Game.AddCollectible("m2_bk6","is_comic");
