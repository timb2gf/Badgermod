...
--
--Game.LoadP3DFile("art\\cars\\homer_v.p3d");
...
--Game.AddVehicleSelectInfo( "ART\\CARS\\gramp_v.p3d", "gramp_v", "grampa" );
...
--Game.GagSetPosition(500.196  ,-20 ,-400.579 );
--Game.GagSetRandom(1);
--Game.GagSetSound("NED5002.wav & NED0201.wav");
--Game.GagSetTrigger("touch", 496.942 , -19.341 , -394 ,  2.0 );
--Game.GagEnd();
...
--Game.GagSetPosition(500.196  ,-20 ,-400.579 );
--Game.GagSetRandom(1);
--Game.GagSetSound("mmcheese.wav");   T:\\Simpsons2\\Sound\\WAVE FILES\\SOUND_FOR_GAGS\\Simpsons_house_sound
...
--Game.GagBegin("gag_k_n2.p3d");
--Game.GagSetInterior("KwikEMart");
--Game.GagSetCycle("cycle");
--Game.GagSetPosition(500 ,-20 ,-300 );
--Game.GagSetRandom(1);
--Game.GagSetSound("gag_k_n2");   
--Game.GagSetTrigger("touch", 505  , -20 , -292 ,  10 );
--Game.GagEnd();
...
--Game.SuppressDriver("eddie");
--Game.SuppressDriver("willie");
