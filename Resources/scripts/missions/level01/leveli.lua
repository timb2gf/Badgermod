...
--ADDING AMBIENT CHARACTERS
	...
	Game.AddAmbientCharacter("lenny", "ambient_lenny",  0); --rail 6
...
--Game.AddBehaviour( "beecamera", "EVADE_PLAYER", "3.0", "8", "1.0", "2.0", "5" );
...
--Game.AddSpawnPointByLocatorScript("static_bee2","beecamera","Shelley","w_powerplant2","20.0","60");
--Game.AddSpawnPointByLocatorScript("static_bee3","beecamera","Shelley","w_powerplant3","20.0","60");
--Game.AddSpawnPointByLocatorScript("static_bee4","beecamera","Shelley","w_powerplant4","20.0","60");
