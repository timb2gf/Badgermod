...
Game.AddStageVehicle("fkwk_v","sr2_AI_carstart2","race","Missions\\level01\\sr2_3rd.con","apu");
Game.SetVehicleAIParams( "fkwk_v", -51, -50 );
Game.SetStageAIRaceCatchupParams("fkwk_v", 80, 0.6, 1.0, 2.0); 
--AddStageVehicle("pickupA","sr2_AI_carstart1","race","Missions\\level01\\sr2_2nd.con");
Game.AddStageVehicle("fcop_v","sr2_AI_carstart3","race","Missions\\level01\\sr2_3rd.con","wiggum");
Game.SetStageAIRaceCatchupParams("fcop_v", 80, 0.6, 0.9, 1.50); 
Game.SetVehicleAIParams( "fcop_v", -51, -50 );
Game.AddStageVehicle("fone_v","sr2_AI_carstart4","race","Missions\\level01\\sr2_3rd.con", "barney");
Game.SetStageAIRaceCatchupParams("fcop_v", 80, 0.6, 0.9, 1.50); 
Game.SetVehicleAIParams( "fone_v", -51, -50 );
