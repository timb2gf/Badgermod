...
Game.AddStageVehicle("fkwk_v","sr2_AI_carstart2","race","Missions\\level01\\sr2_1st.con","apu");
...
Game.AddStageVehicle("fone_v","sr2_AI_carstart4","race","Missions\\level01\\sr2_4th.con", "barney");
Game.SetStageAIRaceCatchupParams("fcop_v", 80, 0.6, 0.9, 1.50); 
