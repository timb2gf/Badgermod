Game.LoadP3DFile("art\\missions\\level01\\m5.p3d");
Game.LoadP3DFile("art\\missions\\level01\\spack.p3d");

Game.LoadDisposableCar("art\\cars\\cVan.p3d","cvan","AI");
Game.LoadDisposableCar("art\\cars\\plowk_v.p3d","plowk_v","OTHER");
